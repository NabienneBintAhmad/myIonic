...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _app_services_authent_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app/services/authent.service */ "./src/app/services/authent.service.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.isSuperadmin = function () {
    ...
    AppComponent.ctorParameters = function () { return [
        { type: _app_services_authent_service__WEBPACK_IMPORTED_MODULE_2__["AuthentService"] },
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_app_services_authent_service__WEBPACK_IMPORTED_MODULE_2__["AuthentService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], AppComponent);
    return AppComponent;
}());
...
var AuthentService = /** @class */ (function () {
    function AuthentService(http, router) {
        this.http = http;
        this.router = router;
        this.host = 'http://localhost:8000/api/login_check';
        this.jwt = '';
        this.username = '';
        this.roles = [''];
        this.statut = '';
    }
    AuthentService.prototype.login = function (loginUserData) {
        return this.http.post(this.host, loginUserData, { observe: 'response' });
    };
    ...
    AuthentService.prototype.isSuperadmin = function () {
        return this.roles.indexOf('ROLE_SUPERADMIN') >= 0;
    };
    AuthentService.prototype.isAdmin = function () {
        return this.roles.indexOf('ROLE_ADMIN') >= 0;
    };
    AuthentService.prototype.isUser = function () {
        return this.roles.indexOf('ROLE_USER') >= 0;
    };
    AuthentService.prototype.isCaissier = function () {
    ...
    AuthentService.prototype.isConnected = function () {
        return this.roles && (this.isAdmin || this.isCaissier || this.isSuperadmin || this.isUser);
    };
    ...
    AuthentService.prototype.loadToken = function () {
...
var TokenInterceptorService = /** @class */ (function () {
    ...
    TokenInterceptorService.prototype.intercept = function (request, next) {
        var authentService = this.injector.get(_services_authent_service__WEBPACK_IMPORTED_MODULE_2__["AuthentService"]);
...
module.exports = __webpack_require__(/*! /home/nabiennebintahmad/Bureau/myapiclone/myIonic/src/main.ts */"./src/main.ts");
